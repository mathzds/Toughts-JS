...
const toughtRoutes = (app: Hono) => {
    ...
    app.post("/toughts/:toughtId/response", toughtController.createResponse.bind(toughtController));
    app.get("/toughts/:toughtId/responses", toughtController.getResponses.bind(toughtController));
};
